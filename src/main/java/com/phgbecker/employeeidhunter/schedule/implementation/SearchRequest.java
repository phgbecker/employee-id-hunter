...
public class SearchRequest {
    ...
    private static Registry<AuthSchemeProvider> setupAuthSchemeProviderRegistry() {
        return RegistryBuilder.<AuthSchemeProvider>create()
                .register(AuthSchemes.NTLM, new NTLMSchemeFactory())
                .build();
    }

    private static BasicCredentialsProvider setupCredentialsProvider() {
    ...
    private static HttpClientBuilder setupHttpClientBuilder(Registry<AuthSchemeProvider> authSchemeRegistry, BasicCredentialsProvider credentialsProvider) {
    ...
    private static HttpResponse postSearch(String search, HttpClientBuilder httpClientBuilder) throws IOException {
